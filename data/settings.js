...
With TLS the login process keeps proxying the connection also after the login,
so the login service needs the same timeout as the service it hands the client
to.
